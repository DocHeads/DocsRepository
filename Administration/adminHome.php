...
echo '<h2 style="font-size: 14px;"><b>Users to be Validated:</b><a href="../Administration/userAdministration.php"><img style="padding-top: 3px; padding-right: 5px;" height="23px" align="right" src="../Images/edit.png"></a></h2>';
...
echo '<h2 style="font-size: 14px;"><b>All User Submissions:</b><a href="../Administration/submissionAdministration.php"><img style="padding-top: 3px; padding-right: 5px;" height="23px" align="right" src="../Images/edit.png"></a></h2>';
#actually show the table
$subTable -> showTable();
echo '</td>
                      </tr>
